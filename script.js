...
const firebaseConfig = {
    ...
    measurementId: "G-DQCJLHT8LY"
        ...
        // Google Login Gate: this is separate from the existing Admin Login.
        const googleGate = document.getElementById('googleGate');
        ...
        auth.onAuthStateChanged((user) => {
            if (user) {
                googleGate.classList.add('hidden');
                document.body.classList.remove('auth-locked');
            } else {
                googleGate.classList.remove('hidden');
